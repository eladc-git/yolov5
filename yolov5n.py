...
def SPPFBlock(x, c_in, c_out, k=5):
    ...
    x = ConvBlock(x, c_in, c_hidden, 1, 1)
    ...
    x = ConvBlock(x, c_hidden * 4, c_out, 1, 1)
    return x
...
if __name__ == "__main__":
    ...
    model = create_yolov5n(image_size, weights_pickle_path=r"E:\Models\yolov5\yolov5n_weights.pkl")
