...
class BottleneckBlock(layers.Layer):
    # Standard bottleneck
    def __init__(self, c_in, c_out, shortcut=True, act=None, e=0.5):  # ch_in, ch_out, shortcut, groups, expansion
        super().__init__()
...
class Upsample(layers.Layer):
    def __init__(self, scale_factor, mode):  # warning: all arguments needed including 'w'
        super().__init__()
